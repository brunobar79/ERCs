...
- **Shortcut 1**: `wallet_sendCalls` ([EIP-5792](./eip-5792.md)) with optimized encodings for ERC-20 transfers, native transfers, and generic calls
...
The `dataCallback` capability enables wallet→server event notifications for enhanced UX and allows apps to request user data. It is defined in [ERC-8026](./erc-8026.md).
